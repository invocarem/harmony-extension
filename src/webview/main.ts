...
const stageLightAssumptions = document.getElementById(
  "stage-light-assumptions"
);
const stageLightImplementation = document.getElementById(
  "stage-light-implementation"
);

if (stageLightAssumptions) {
  stageLightAssumptions.addEventListener("click", () => {
...
if (stageLightImplementation) {
  stageLightImplementation.addEventListener("click", () => {
